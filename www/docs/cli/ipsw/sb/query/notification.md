...
description: Find profiles that can post a darwin/distributed notification
---
## ipsw sb query notification

Find profiles that can post a darwin/distributed notification

```
ipsw sb query notification <TARGET> [KERNELCACHE] [flags]
```
