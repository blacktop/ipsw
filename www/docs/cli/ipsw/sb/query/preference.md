...
description: Find profiles that can read/write a preference domain
---
## ipsw sb query preference

Find profiles that can read/write a preference domain

```
ipsw sb query preference <TARGET> [KERNELCACHE] [flags]
```
