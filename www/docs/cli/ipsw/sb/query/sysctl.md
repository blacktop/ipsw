...
description: Find profiles that can read/write a sysctl
---
## ipsw sb query sysctl

Find profiles that can read/write a sysctl

```
ipsw sb query sysctl <TARGET> [KERNELCACHE] [flags]
```
