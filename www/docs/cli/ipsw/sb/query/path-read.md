...
sidebar_label: path-read
description: Find profiles that can read from a path
---
## ipsw sb query path-read

Find profiles that can read from a path

```
ipsw sb query path-read <TARGET> [KERNELCACHE] [flags]
```

### Options

```
  -h, --help   help for path-read
```
