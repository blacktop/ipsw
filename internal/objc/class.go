...
func (cls Class) IsMetaClass() bool {
	return C.class_isMetaClass(cls.cclass()) != C.BOOL(false)
}
...
func (cls Class) RespondsToSelector(sel Sel) bool {
	return C.class_respondsToSelector(cls.cclass(), sel.csel()) != C.BOOL(false)
}
...
func (cls Class) ConformsToProtocol(prot Protocol) bool {
	return C.class_conformsToProtocol(cls.cclass(), prot.cprot()) != C.BOOL(false)
}
