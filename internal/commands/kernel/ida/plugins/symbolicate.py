...
class SymbolicatePlugin(idaapi.plugin_t):
    flags = 0
    comment = "'ipsw' Symbolicate Plugin"
    help = "This 'ipsw' plugin prompts the user for a symbol map JSON file and processes it."
    wanted_name = "'ipsw' Symbolicate Plugin"
    wanted_hotkey = "Alt-F8"
    
    def init(self):
        print("'ipsw' Symbolicate Plugin initialized.")
    ...
    def term(self):
        # print("'ipsw' Symbolicate Plugin terminated.")
