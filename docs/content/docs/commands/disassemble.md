...
draft: false
weight: 12
summary: Disassemble ARMv8.3 binaries.
---
...
⚠️ **NOTE:** requires **capstone** installed from the `next` branch _(brew install capstone --HEAD)_
...
```bash
$ ipsw disass --vaddr 0xfffffff007b7c05c --instrs 100 kernelcache.release.iphone12.decompressed \
   | bat -p --tabs 0 -l s
```
